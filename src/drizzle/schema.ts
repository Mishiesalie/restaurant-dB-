...
// relations([
//     // Restaurant to City
//     restaurant_table.belongsTo<restaurant_table, city_table>("city", {
//         foreignKey: "city_id",
//         targetKey: "id",
//         target: city_table
//     }),

//     // Menu Item to Restaurant
//     menu_items_table.belongsTo<menu_items_table, restaurant_table>("restaurant", {
//         foreignKey: "restaurant_id",
//         targetKey: "id",
//         target: restaurant_table
//     }),

//     // Menu Item to Category
//     menu_items_table.belongsTo<menu_items_table, category_table>("category", {
...
//     // City to State
//     city_table.belongsTo<city_table, state_table>("state", {
//         foreignKey: "state_id",
//         targetKey: "id",
//         target: state_table
//     }),
...
//     // Address to City
//     address_table.belongsTo<address_table, city_table>("city", {
//         foreignKey: "city_id",
//         targetKey: "id",
//         target: city_table
//     }),
...
//     // Address to User
//     address_table.belongsTo<address_table, users_table>("user", {
//         foreignKey: "user_id",
//         targetKey: "id",
//         target: users_table
//     }),

//     // Restaurant Owner to Restaurant
//     restaurant_owner_table.belongsTo<restaurant_owner_table, restaurant_table>("restaurant", {
//         foreignKey: "restaurant_id",
//         targetKey: "id",
//         target: restaurant_table
//     }),
...
//     restaurant_owner_table.belongsTo<restaurant_owner_table, users_table>("user", {
//         foreignKey: "owner_id",
//         targetKey: "id",
//         target: users_table
//     }),
...
//     // Driver to User
//     driver_table.belongsTo<driver_table, users_table>("user", {
//         foreignKey: "user_id",
//         targetKey: "id",
//         target: users_table
//     }),
...
//     // Comment to User
//     comment_table.belongsTo<comment_table, users_table>("user", {
//         foreignKey: "user_id",
//         targetKey: "id",
//         target: users_table
//     }),
...
//     // Comment to Order
//     comment_table.belongsTo<comment_table, orders_table>("order", {
//         foreignKey: "order_id",
//         targetKey: "id",
//         target: orders_table
//     }),

//     // Order Menu Item to Order
//     order_menu_item_table.belongsTo<order_menu_item_table, orders_table>("order", {
//         foreignKey: "order_id",
//         targetKey: "id",
//         target: orders_table
//     }),

//     // Order Menu Item to Menu Item
//     order_menu_item_table.belongsTo<order_menu_item_table, menu_items_table>("menu_item", {
//         foreignKey: "menu_item_id",
//         targetKey: "id",
//         target: menu_items_table
//     }),

//     // Order Status to Order
//     order_status_table.belongsTo<order_status_table, orders_table>("order", {
//         foreignKey: "order_id",
//         targetKey: "id",
//         target: orders_table
//     }),

//     // Order Status to Status Catalog
//     order_status_table.belongsTo<order_status_table, status_catalog_table>("status_catalog", {
//         foreignKey: "status_catalog_id",
//         targetKey: "id",
//         target: status_catalog_table
//     }),
// ]);
